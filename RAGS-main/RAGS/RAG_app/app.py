...
f = open(r"D:\DATA_SCIENCE_INTERNSHIP\RAGS-main\RAGS-main\RAGS\KEY\geminiai_key.txt")
KEY = f.read()
...
dat = PDFMinerLoader(r"D:\DATA_SCIENCE_INTERNSHIP\RAGS-main\RAGS-main\RAGS\2404.07143.pdf")
dat_nik =dat.load()
